        ...
        <div class="row">
            <div class="col-12 fh5co_mediya_center"><a  class="color_fff fh5co_mediya_setting"><i
                  ...
                  <?php
                        ...
                        $a = date ("H");
                        if (($a>=6) && ($a<=11)){
                        echo ", Selamat Pagi Warga RW 09 Pondok Indah Kutabumi Tangerang.. ";
                        }
                        else if(($a>11) && ($a<=15))
                        {
                        echo ", Selamat Siang Warga RW 09 Pondok Indah Kutabumi Tangerang.. " ;
                        }
                        else if (($a>15) && ($a<=18)){
                        echo ", Selamat Sore Warga RW 09 Pondok Indah Kutabumi Tangerang..";
                        }
                        else { echo ", <b> Selamat Malam Warga RW 09 Pondok Indah Kutabumi Tangerang</b>";}
...
<div class="container-fluid bg-faded fh5co_padd_mediya padding_786" id="pepek" >
  ...
  <footer class="py-3 bg-dark">
    <div class="container">
      <p class="m-0 text-center text-white">Copyright &copy; RW 09 Kutabumi Tangerang 2020</p>
    </div>
    <!-- /.container -->
  </footer>
