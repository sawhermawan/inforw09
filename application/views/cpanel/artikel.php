          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>RW 09 <small>Artikel</small></h3>
              </div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <div class="row">
                      <div class="col-lg-6">
                        <a href="<?php echo base_url();?>index.php/artikel/addArtikel">
                        <button type="button" class="btn btn-success btn-sm" title="New"><i class="fa fa-plus"></i></button><b>Artikel</b></a>
                      </div>
                    </div>
                    <div class="clearfix"></div>
                  </div>
                ...
                <!-- modal add List Siswa -->
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-checkbox" class="table table-striped table-bordered bulk_action">
                      ...
                      <tbody>
                        <?php $no = 0; ?>
                        <?php foreach ($m_home->result() as $art): ?>
                        <?php $no++; ?>
                          <tr>
                            <td><?php echo $no; ?></td>
                            <td><?php echo $art->judul_acara; ?></td>
                            <td><?php echo $art->artikel; ?></td>
                            <td><?php echo $art->tanggal; ?></td> 
                            <td><?php echo$art->picture; ?></td>
                            <td class="text-center">
                            <a href="<?php echo base_url('index.php/artikel/edit/'.$art->berita_id)?>" title="Click to Edit" class="btn btn-info"><i class="fa fa-edit"></i> Edit</a>

                            <a id="delete" data-toggle="modal" data-target="#myModalDelete" 
                            data-id="<?php echo $art->berita_id; ?>">
          ...
          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModalDelete" class="modal fade">
              <div class="modal-dialog">
                  <div class="modal-content">
                      ...
                      <form class="form-horizontal" action="<?php echo base_url('index.php/artikel/delete')?>" method="post" enctype="multipart/form-data" role="form">
