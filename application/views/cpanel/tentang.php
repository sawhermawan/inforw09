          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Tentang <small>Kami</small></h3>
              </div>
                ...
                <!--end modal tambah jobdesk-->
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-checkbox" class="table table-striped table-bordered bulk_action">
                      ...
                      <tbody>
                        <?php $no = 0; ?>
                        <?php foreach ($m_tentang->result() as $tent): ?>
                        <?php $no++; ?>
                          <tr>
                            <td><?php echo $no; ?></td>
                            <td><?php echo $tent->sejarah_rw09; ?></td>
                            <td><?php echo $tent->visi; ?></td>
                            <td><?php echo $tent->misi; ?></td>
                            <td class="text-center">
                            <a href="<?php echo base_url('index.php/tentang/edit/'.$tent->tentang_id)?>" title="Click to Edit" class="btn btn-info"><i class="fa fa-edit"></i> Edit</a>

                            <a id="delete" data-toggle="modal" data-target="#myModalDeleteUnit" 
                            data-id="<?php echo $tent->tentang_id; ?>">
          ...
          <!-- <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModaleditUnit" class="modal fade">
              <div class="modal-dialog">
                  <div class="modal-content">
                      ...
                      <form class="form-horizontal" action="<?php echo base_url('index.php/tentang/edit')?>" method="post" enctype="multipart/form-data" role="form">
           ...
           <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModalDeleteUnit" class="modal fade">
              <div class="modal-dialog">
                  <div class="modal-content">
                      ...
                      <form class="form-horizontal" action="<?php echo base_url('index.php/tentang/delete')?>" method="post" enctype="multipart/form-data" role="form">
                        <div class="modal-body" id="modal-delete">
                          <div class="row">

                            <input type="hidden" id="id" name="tentang_id">
                ...
                <script type="text/javascript">
                  $(document).on("click","#delete", function() {
                    var tentang_id        =  $(this).data('id');
                    $("#modal-delete #id").val(tentang_id);
                  })
                </script> 
